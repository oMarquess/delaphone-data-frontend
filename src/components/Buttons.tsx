const Button = (props: React.PropsWithChildren) => {
  return (
  <button className="relative py-3 px-6 rounded-lg overflow-hidden font-medium text-sm bg-gradient-to-b from-[#8c45ff] to-[#5F17ED] shadow-[0px_0px_12px_#8c45ff]">
    ...
    <span className="relative text-white font-medium">{props.children}</span>
  </button>
  );
};
